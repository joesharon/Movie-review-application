...
function Romance() {
    ...
    const fetchMovies = async () => {
      try {
        const response = await fetch(
          'https://api.themoviedb.org/3/discover/movie?api_key=2e3ca7f46f064a5287d18b21277f0f99&with_genres=10749'
        );
        if (response.ok) {
  ...
  return (
      ...
      <div>
      <h1 style={{backgroundColor:'yellowgreen'}}>Romance</h1>
      <center><FavoriteIcon/></center>
      </div>
      {movies.map((movie) => (
